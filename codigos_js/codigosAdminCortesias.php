...
//-----------------------------------------------------------------------------------------------------------------------------//	
	...
	function objetos() {
		$.ajax({
			...
			objetosBD = response;
				if(objetoUm.length !== objetoDois.length){	
					criaPagina();
				} 
			}
		});
...
//-----------------------------------------------------------------------------------------------------------------------------//
	...
	function atualizarValores(){//Função q contem todas as  chamadas dos itens para verirficar sua quantidade no estoque
		for (var nomeProduto in objetosBD) {
...
//-----------------------------------------------------------------------------------------------------------------------------//
	function validarEnvio(){//Verifica se o valor da compra é maior que zero quando o subtotal é pressionado, se não for, cancela o envio do formulário
		...
		localStorage.setItem('bodyCortesia', body);
